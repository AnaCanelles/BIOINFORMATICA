...
(poner refernce.bib en la carpeta doc de practicas para usarlo como bibliografía
...
ls() en la consola para que nos diga qué cosas hemos hecho
...
2.  Busca una función de R que te permita identificar las líneas repetidas en un marco de datos. (consultar el dataframe con genomas\[c(7,8), \]compara las filas 7 y 8 en todas sus columnas, solo cambia el nombre)
:::
